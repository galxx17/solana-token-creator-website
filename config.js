...
window.rpc =
  "https://mainnet.helius-rpc.com/?api-key=de06113e-740a-4784-8216-845e7c389cb7"; // solana rpc
window.pinata_secret_api_key =
  "796c5b2d7a9c6c479a7456be654ec2d00d5dc8ab6aa8f063e00fb6c5c579860d"; // pinata secret api key
window.pinata_api_key = "5b2338f6adcfd9036fb8"; // pinata api key

// footer social links
window.footer_twitter = "";
window.footer_discord = "";
window.footer_telegram = "";

// branding
window.project_name = "galloxdeploy.fun";
window.project_domain = "galloxdeploy.fun";
